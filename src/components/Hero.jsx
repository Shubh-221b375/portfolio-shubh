        ...
        <div className='w-full lg:w-1/2 lg:p-8'>
          <div className='flex flex-col items-center lg:items-start'>
            ...
            <motion.span 
              ...
              initial="hidden"
              animate="visible"
              className='bg-gradient-to-r from-pink-500 via-slate-400 to-purple-500 bg-clip-text text-3xl tracking-tight text-transparent min-h-[48px]'
            >
              ...
              <ReactTypingEffect
                ...
                typingDelay={400}
                eraseDelay={1200}
                cursorRenderer={cursor => <span className="text-purple-400">{cursor}</span>}
              />
            </motion.span>
            <motion.p 
